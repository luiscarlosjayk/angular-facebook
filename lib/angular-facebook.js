            ...
            var tmpArguments = arguments,
                ...
                deferFunc = function() {
                  var resultFunc = function(result) {
                    // prevents the "$digest phase already in progress" error :)
                    if($rootScope.$$phase) {
                      qq.resolve(result);
                    } else {
                      $rootScope.$apply(function() {
                  ...
                  if(tmpArguments.length) {
                    FB[name](tmpArguments[0], resultFunc);
                  } else {
                    FB[name](resultFunc);
                  }
                };
              ...
              if (angular.isUndefined(window.FB)) {
                deferred.promise.then(deferFunc);
              } else {
                deferFunc();
              }
